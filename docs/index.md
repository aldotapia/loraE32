...
**NOTE: author is [effevee](https://github.com/effevee/loraE32)**

**This is his original documentation:**

[User manual EBYTE E32 series](assets/E32_Usermanual_EN_v1.30.pdf)

## E32-868T20D

[User manual EBYTE E32-868T20D](assets/E32-868T20D_Usermanual_EN_v1.5.pdf)

![E32-868T20D](assets/E32868T20D.jpg)
...
![E32-868T20D](assets/E32868T20D_pinout.jpg)
...
![E32-868T20D](assets/E32868T20D_transmodes.jpg) 
...
All modules can have different addresses and channels. The transmission messages are prefixed with the destination address and channel information. If these differ from the settings of the transmitter, then the configuration of the module will be changed before the transmission. After the transmission is complete, the transmitter will revert to its prior configuration.
    ...
    ![E32-868T20D](assets/E32868T20D_fixed_P2P.jpg)
    ...
    ![E32-868T20D](assets/E32868T20D_fixed_Broadcast.jpg)
...
![E32-868T20D](assets/E32868T20D_config.jpg)
...
![E32-868T20D](assets/E32868T20D_transmit_transparent.jpg)
...
![E32-868T20D](assets/E32868T20D_transmit_normal.jpg)
...
![E32-868T20D](assets/E32868T20D_transmit_wakeup.jpg)
...
![E32-868T20D](assets/E32868T20D_receive.jpg)
...
![E32-868T20D](assets/E32868T20D_setconfig_save.jpg)

1. __Command set config with temporary save__\
The device is in sleep mode (both M0 and M1 high). Some time after the set config command is received on the RXD pin of the module, the AUX pin goes low. After the config response is sent to the TXD pin, the AUX pin goes high.
![E32-868T20D](assets/E32868T20D_setconfig_nosave.jpg)
...
![E32-868T20D](assets/E32868T20D_getconfig.jpg)
...
![E32-868T20D](assets/E32868T20D_getversion.jpg)
...
![E32-868T20D](assets/E32868T20D_reset.jpg)

## Test setup with ESP32

![E32-868T20D](assets/E32868T20D_test_setup.jpg)
...
```
[class ebyteE32 code](reference.md)
...
1. __Sensor nodes__ 
    ...
    ![E32-868T20D](assets/E32_sensor_node_01.jpg)
...
1. __Monitor node__ ([code](examples/POC/MonitorNodeE32.py))
    ...
    ![E32-868T20D](assets/E32_monitor_node.jpg)
...
1. __Grafana server__
    ...
    ![E32-868T20D](assets/Grafana_dashboard.jpg)
    - __panel 1__ : Temperature\
    ![E32-868T20D](assets/Grafana_graph1.jpg)
    - __panel 2__ : Humidity\
    ![E32-868T20D](assets/Grafana_graph2.jpg)
    - __panel 3__ : Pressure\
    ![E32-868T20D](assets/Grafana_graph3.jpg)
